...
function CategoryShowCase() {
  ...
  const filterItem = (category) => {
    ...
    setItems(ProductData.filter((Products) => Products.cate == category));
  };
  return (
    <div className="course-section style-3 padding-tb">
      ...
      <div className="cointainer">
        ...
        <div className="section-wrapper">
          <div className="row g-4 justify-content-center row-cols-xl-4 row-cols-l-3 row-cols-md-2 row-cols-sm-1 course-filter">
            {items.map((products) => (
                ...
                <div className="course-item style-4">
                  <div className="course-inner">
                    ...
                    <div className="course-content">
                      <Link to={`/shop/${products.id}`}>{products.title}</Link>
